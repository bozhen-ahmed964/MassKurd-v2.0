<section class="text-gray-400 bg-gray-900 body-font">
    <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        ...
        <form method="post" action="{{ route('logout') }}" class=" top-6 right-6">
            @csrf

            <button
                class="inline-flex items-center bg-red-700 border-0 py-1 px-3 focus:outline-none hover:bg-red-600 rounded mt-4 md:mt-0 text-white">
                Logout
