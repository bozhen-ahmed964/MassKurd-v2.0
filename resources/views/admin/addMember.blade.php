...
@section('content')
    <form method="post" action="{{ url('/admin/storeMember') }}" class="text-gray-400 bg-gray-900 body-font">
        @csrf
        <div class="max-w-5xl space-y-5 px-5 py-24 mx-auto">
            ...
            <div class="flex sm:flex-row flex-col mx-auto  items-end gap-5">
                ...
                <div class="relative sm:mb-0 flex-grow w-full">
                    ...
                    <input type="number" id="age" name="age" min="0" value="{{ old('age') }}" required
                        class="w-full bg-gray-800 bg-opacity-40 rounded border border-gray-700 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-900 focus:bg-transparent text-base outline-none text-gray-100 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                </div>
                ...
                <div class="relative sm:mb-0 flex-grow w-full">
                    ...
                    <input type="number" id="weight" name="weight" min="0" value="{{ old('weight') }}" required
                        class="w-full bg-gray-800 bg-opacity-40 rounded border border-gray-700 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-900 focus:bg-transparent text-base outline-none text-gray-100 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                </div>

                <div class="relative sm:mb-0 flex-grow w-full">
                    <label for="height" class="leading-7 text-sm text-gray-400">Height</label>
                    <input type="number" id="height" name="height" min="0" value="{{ old('height') }}" required
                        class="w-full bg-gray-800 bg-opacity-40 rounded border border-gray-700 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-900 focus:bg-transparent text-base outline-none text-gray-100 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                </div>
            ...
            <div class="flex justify-end">
                <button type="submit" class="bg-blue-600 hover:bg-blue-700 rounded text-sm font-bold text-gray-50 py-2 px-2 ">Add
                    Member</button>
            </div>
